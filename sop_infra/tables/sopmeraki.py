...
MOVE_TO_NETWORK = """
{# TODO - CHECK PERMS ON SOURCE NET #}
{% if record.pk %}
  <a href="{% url 'plugins:sop_infra:sopmerakidevice_move' record.pk %}?return_url={{ request.get_full_path|urlencode }}" class="btn btn-purple" role="button">
